...
import org.yanzi.activity.ActivityRegisterSelectCollege;
 ...
 * 这个是注册界面选择入学时间的适配器
 */
public class RegisterSchoolOpensTimeAdapter extends BaseAdapter{
    private Context context;
    private List<String> listcity;
    private String province,city,school;

    public RegisterSchoolOpensTimeAdapter(Context context, List<String> listcity,
                                          String province, String city,String school) {
    ...
    private void onclick(final String string, ViewHolder viewHolder) {
        ...
        viewHolder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, ActivityRegisterSelectCollege.class);
