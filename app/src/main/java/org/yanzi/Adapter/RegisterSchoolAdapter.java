...
import org.yanzi.activity.ActivitySchoolOpensTime;
 ...
 * 这个是注册界面学校选择页面的适配器
 */
public class RegisterSchoolAdapter extends BaseAdapter{
    private Context context;
    private List<String> listcity;
    private String province,city;

    public RegisterSchoolAdapter(Context context, List<String> listcity, String province,String city) {
    ...
    private void onclick(final String string, ViewHolder viewHolder) {
        ...
        viewHolder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, ActivitySchoolOpensTime.class);
